...
public class EmpresaController implements Serializable {
    ...
    @EJB
    private beans.EmpresaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Nombres").getString("EmpresaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Nombres").getString("EmpresaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Nombres").getString("EmpresaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
