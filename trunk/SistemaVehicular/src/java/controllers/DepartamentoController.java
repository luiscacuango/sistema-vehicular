...
public class DepartamentoController implements Serializable {
    ...
    @EJB
    private beans.DepartamentoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Nombres").getString("DepartamentoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Nombres").getString("DepartamentoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Nombres").getString("DepartamentoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
