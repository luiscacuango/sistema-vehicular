...
public class EmpleadoController implements Serializable {
    ...
    @EJB
    private beans.EmpleadoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Nombres").getString("EmpleadoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Nombres").getString("EmpleadoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Nombres").getString("EmpleadoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class EmpleadoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Empleado) {
                ...
                return getStringKey(o.getIdEmpl());
            } else {
