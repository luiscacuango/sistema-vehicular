...
@ManagedBean(name = "ordenMovilizacionController")
@SessionScoped
public class OrdenMovilizacionController implements Serializable {
    ...
    public OrdenMovilizacionController() {
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Nombres").getString("OrdenMovilizacionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Nombres").getString("OrdenMovilizacionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Nombres").getString("OrdenMovilizacionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class OrdenMovilizacionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            OrdenMovilizacionController controller = (OrdenMovilizacionController) facesContext.getApplication().getELResolver().
