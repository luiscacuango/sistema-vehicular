...
import beans.TipoEmpleadoFacade;
...
public class TipoEmpleadoController implements Serializable {
    ...
    @EJB
    private beans.TipoEmpleadoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Nombres").getString("TipoEmpleadoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Nombres").getString("TipoEmpleadoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Nombres").getString("TipoEmpleadoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class TipoEmpleadoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoEmpleado) {
                ...
                return getStringKey(o.getIdTipoempl());
            } else {
