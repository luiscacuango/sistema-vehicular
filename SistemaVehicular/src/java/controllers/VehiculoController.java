...
public class VehiculoController implements Serializable {
    ...
    @EJB
    private beans.VehiculoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Nombres").getString("VehiculoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Nombres").getString("VehiculoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Nombres").getString("VehiculoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class VehiculoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Vehiculo) {
                ...
                return getStringKey(o.getIdVehi());
            } else {
